...
export default function Exams() {
  return (
    <div className="mb-28 font-medium flex flex-col items-center  ">
      ...
      <div className="flex justify-evenly w-full gap-10 px-36 max-md:px-0 max-md:gap-3 md:max-xl:px-2 md:max-xl:gap-5 ">
        <Sidebar />
      ...
      <div className="mt-28 max-md:mt-16 bg-black max-md:grid  rounded-xl text-white flex justify-between w-5/6 mb-28">
        ...
        <div className="px-20 pr-20 max-md:px-0 md:max-xl:px-0 md:max-xl:mt-auto flex justify-center ">
